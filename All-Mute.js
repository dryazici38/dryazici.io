...
module.exports = {
  conf: {
    aliases: ["allmute", "herkesisustur", "toplusustur"],
    name: "Allmute",
    help: "allmute Sesli kanalda bulunan herkese sağ tık mute atar.",
  },
  ...
  run: async (client, message, args, embed) => {
    ...
    message.channel.send(embed.setDescription(`<a:f_isaret2:883470992104644639> \`${channel.name}\` kanalındaki tüm üyeler başarıyla susturuldu!`)), message.react(emojis.mark);
  },
};
